    ...
    <ChakraProvider>
      <Flex direction="column" alignItems="center" mb={'2%'}>
        ...
        >
          ...
          <Text fontSize="15px" fontWeight="700" mt={'1%'} mb={'1%'} align={'left'}>
          ...
          <br></br>
          <Text fontSize={'md'} fontWeight="600" paddingLeft={'2%'} paddingRight={'2%'}>
            Fees for participants include Symposium proceedings, Symposium kit,
            lunch, Gala dinner and excursion. The accompanying Guest fee
            includes everything apart from the Symposium proceedings and the
            Symposium kit. Please note the fees do not include accommodation for
            invited speakers, participants or accompanying guests. Accommodation
            related information will be available separately on the SIS2024
            webpage.
            <br></br>
            <br></br>
          ...
          <Text paddingLeft={'2%'} paddingRight={'2%'}>
            <br></br>
            Registration will be complete once payment has been received into
            the Symposium account. National delegates and students will need to
            pay the registration fee via the SBI collect portal.
            <b>
              <br></br>
